...
def get_current_period():
    ...
    response = requests.post("http://141.94.218.103:33035/", data=payload, headers=headers)
...
def send_tx_list(tx_list):
    ...
    return requests.post('http://141.94.218.103:33035/', data=payload, headers=headers)


senderkey_faucet = KeyPair.from_secret_massa_encoded("S1PNNeC922hHaveiosug8GzLidmbfHeu57GnUZsXcbtQm5Gfdfy")
